...
namespace Tektosyne.UnitTest {
    ...
    using TestTuple = ValueTuple<String, Double?, Int32, Int32?>;

    [TestFixture]
    public class ValueTuple4Test {

        [Test]
        public void EqualsTest() {
            Assert.AreEqual(new TestTuple(), TestTuple.Empty);
        ...
        public void EqualsOperatorTest() {
            Assert.IsTrue(new TestTuple() == TestTuple.Empty);

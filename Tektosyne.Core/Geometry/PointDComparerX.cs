...
namespace Tektosyne.Geometry {
    ...
    /// cref="PointD.X"/> coordinates.</summary>
    /// <remarks><para>
    /// <b>PointDComparerX</b> defines a lexicographic ordering for <see cref="PointD"/> instances,
    /// sorting first by <see cref="PointD.X"/> and then by <see cref="PointD.Y"/> coordinates. Use
    /// <see cref="PointDComparerY"/> to sort first by <see cref="PointD.Y"/> coordinates.
    /// </para><para>
    ...
    [Serializable]
    public class PointDComparerX: IPointDComparer {
        ...
        public int CompareEpsilon(PointD a, PointD b) {
            ...
            int result = MathUtility.Compare(a.X, b.X, _epsilon);
            if (result != 0) return result;
            return MathUtility.Compare(a.Y, b.Y, _epsilon);
        }
        ...
        public static int CompareEpsilon(PointD a, PointD b, double epsilon) {
            ...
            int result = MathUtility.Compare(a.X, b.X, epsilon);
            if (result != 0) return result;
            return MathUtility.Compare(a.Y, b.Y, epsilon);
        }
        ...
        /// <paramref name="b"/> by first comparing their <see cref="PointD.X"/> coordinates, and in
        /// case of equality then comparing their <see cref="PointD.Y"/> coordinates. Smaller
        ...
        /// sorted lexicographically using a <see cref="PointDComparerX"/> with the current <see
        /// cref="Epsilon"/>.</param>
        /// <param name="q">
        ...
        /// cref="PointDComparerX"/> methods with the current <see cref="Epsilon"/>.
        /// </para><para>
        ...
        public int FindNearest(IList<PointD> points, PointD q) {
            ...
            // (see PointDComparerY for an alternative algorithm)

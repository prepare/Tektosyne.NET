namespace Tektosyne {
    ...
    /// <summary>
    /// Provides static methods for creating <see cref="MutableTuple"/> instances.</summary>
    /// <remarks>
    /// <b>MutableTuple</b> offers static <b>Create</b> methods for all <see cref="MutableTuple"/>
    ...
    public static class MutableTuple {
        ...
        /// <summary>
        /// Creates a new <see cref="MutableTuple{T1,T2}"/>.</summary>
        /// <typeparam name="T1">
        ...
        /// <returns>
        /// A <see cref="MutableTuple{T1,T2}"/> containing the specified <paramref name="item1"/>
        /// and <paramref name="item2"/>.</returns>
        /// <remarks>
        /// <b>Create</b> allows you to create a new <see cref="MutableTuple{T1,T2}"/> without
        ...
        /// <summary>
        /// Creates a new <see cref="MutableTuple{T1,T2,T3}"/>.</summary>
        /// <typeparam name="T1">
        /// The type of the first component.</typeparam>
        /// <typeparam name="T2">
        /// The type of the second component.</typeparam>
        ...
        /// <returns>
        /// A <see cref="MutableTuple{T1,T2,T3}"/> containing the specified <paramref
        /// name="item1"/>, <paramref name="item2"/>, and <paramref name="item3"/>.</returns>
        /// <remarks>
        /// <b>Create</b> allows you to create a new <see cref="MutableTuple{T1,T2,T3}"/> without
        /// having to explicitly specify its generic type arguments.</remarks>
        ...
        /// <summary>
        /// Creates a new <see cref="MutableTuple{T1,T2,T3,T4}"/>.</summary>
        /// <typeparam name="T1">
        /// The type of the first component.</typeparam>
        /// <typeparam name="T2">
        /// The type of the second component.</typeparam>
        ...
        /// <returns>
        /// A <see cref="MutableTuple{T1,T2,T3,T4}"/> containing the specified <paramref
        /// name="item1"/>, <paramref name="item2"/>, <paramref name="item3"/>, and <paramref
        /// name="item4"/>.</returns>
        /// <remarks>
        /// <b>Create</b> allows you to create a new <see cref="MutableTuple{T1,T2,T3,T4}"/> without
        /// having to explicitly specify its generic type arguments.</remarks>

        public static MutableTuple<T1, T2, T3, T4>

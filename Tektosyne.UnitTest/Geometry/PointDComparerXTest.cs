...
namespace Tektosyne.UnitTest.Geometry {
    ...
    [TestFixture]
    public class PointDComparerXTest {

        [Test]
        public void Compare() {
            var comparer = new PointDComparerX();
        ...
        public void CompareEpsilonStatic() {
            Assert.AreEqual(-1, PointDComparerX.CompareEpsilon(new PointD(1, 2), new PointD(1.1, 2), 0.01));
            Assert.AreEqual(-1, PointDComparerX.CompareEpsilon(new PointD(1, 2), new PointD(1, 2.1), 0.01));
            Assert.AreEqual(+1, PointDComparerX.CompareEpsilon(new PointD(1, 2), new PointD(0.9, 2), 0.01));
            Assert.AreEqual(+1, PointDComparerX.CompareEpsilon(new PointD(1, 2), new PointD(1, 1.9), 0.01));

            Assert.AreEqual(0, PointDComparerX.CompareEpsilon(new PointD(1, 2), new PointD(1.1, 2), 0.5));
            Assert.AreEqual(0, PointDComparerX.CompareEpsilon(new PointD(1, 2), new PointD(1, 2.1), 0.5));
            Assert.AreEqual(0, PointDComparerX.CompareEpsilon(new PointD(1, 2), new PointD(0.9, 2), 0.5));
            Assert.AreEqual(0, PointDComparerX.CompareEpsilon(new PointD(1, 2), new PointD(1, 1.9), 0.5));
        }

        [Test]
        public void CompareExact() {
            Assert.AreEqual(0, PointDComparerX.CompareExact(new PointD(1, 2), new PointD(1, 2)));
            Assert.AreEqual(-1, PointDComparerX.CompareExact(new PointD(1, 2), new PointD(2, 2)));
            Assert.AreEqual(-1, PointDComparerX.CompareExact(new PointD(1, 2), new PointD(1, 3)));
            Assert.AreEqual(+1, PointDComparerX.CompareExact(new PointD(1, 2), new PointD(0, 2)));
            Assert.AreEqual(+1, PointDComparerX.CompareExact(new PointD(1, 2), new PointD(1, 1)));

            Assert.AreEqual(-1, PointDComparerX.CompareExact(new PointD(1, 2), new PointD(2, 1)));
            Assert.AreEqual(+1, PointDComparerX.CompareExact(new PointD(2, 1), new PointD(1, 2)));
        }

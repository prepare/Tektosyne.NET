...
namespace Tektosyne.UnitTest.Collections {
    ...
    using Int32StringDictionary = SortedListEx<Int32, CloneableType>;

    using StringStringPair = KeyValuePair<String, CloneableType>;
    using StringStringDictionary = SortedListEx<String, CloneableType>;

    [TestFixture]
    public class SortedListExTest {
        ...
        public void SetUp() {
            ...
            Assert.AreEqual(0, _dictionary.Capacity);
        ...
        public void Constructor() {
            StringStringDictionary dictionary = new StringStringDictionary(567);
            dictionary.Add("foo", "foo value");
            dictionary.Add("bar", "bar value");
            Assert.AreEqual(567, dictionary.Capacity);
            Assert.AreEqual(2, dictionary.Count);

            StringStringDictionary clone = new StringStringDictionary(dictionary);
            Assert.AreEqual(2, clone.Capacity);
            Assert.AreEqual(2, clone.Count);
        }

        [Test]
        public void Capacity() {
            Assert.Throws<ArgumentOutOfRangeException>(() => _dictionary.Capacity = 0);
            Assert.Throws<NotSupportedException>(() => _readOnly.Capacity = _dictionary.Capacity);

            _dictionary.Capacity = 238;
            Assert.AreEqual(238, _dictionary.Capacity);
        ...
        public void Add() {
            ...
            Assert.AreEqual(32, _dictionary.Capacity);
        }
        ...
        public void Clear() {
            ...
            _dictionary.Clear();
            Assert.AreEqual(4, _dictionary.Capacity);
            Assert.AreEqual(0, _dictionary.Count);
        }
        ...
        [Test]
        public void GetKey() {
            Assert.Throws<ArgumentOutOfRangeException>(() => _dictionary.GetKey(-1));
            Assert.Throws<ArgumentOutOfRangeException>(() => _dictionary.GetKey(3));

            Assert.AreEqual("one", _dictionary.GetKey(0));
            Assert.AreEqual("three", _dictionary.GetKey(1));
            Assert.AreEqual("two", _dictionary.GetKey(2));
        }

        [Test]
        public void IndexOfKey() {
            Assert.AreEqual(0, _dictionary.IndexOfKey("one"));
            Assert.AreEqual(1, _dictionary.IndexOfKey("three"));
            Assert.AreEqual(2, _dictionary.IndexOfKey("two"));
            Assert.AreEqual(-1, _dictionary.IndexOfKey("four"));
        }

        [Test]
        public void IndexOfValue() {
            Assert.AreEqual(0, _dictionary.IndexOfValue("first value"));
            Assert.AreEqual(1, _dictionary.IndexOfValue("third value"));
            Assert.AreEqual(2, _dictionary.IndexOfValue("second value"));
            Assert.AreEqual(-1, _dictionary.IndexOfValue("fourth value"));
        }
        ...
        public void SetByIndex() {
            Assert.Throws<ArgumentOutOfRangeException>(() =>
                _dictionary.SetByIndex(-1, "new fourth value"));
            Assert.Throws<ArgumentOutOfRangeException>(() =>
                _dictionary.SetByIndex(3, "new fourth value"));
            Assert.Throws<NotSupportedException>(() => _readOnly.SetByIndex(0, "new first value"));

            _dictionary.SetByIndex(0, "new first value");
            Assert.AreEqual("one", _dictionary.GetKey(0));

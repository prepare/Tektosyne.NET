...
namespace Tektosyne.Collections {
    ...
    /// <remarks><para>
    /// <b>DictionaryEx</b> provides a <see cref="Dictionary{TKey, TValue}"/>, which is a dynamic
    ...
    /// </item><item>
    /// <see cref="DictionaryEx{TKey, TValue}.AsReadOnly"/> returns a read-only wrapper that has the
    ...
    /// </item><item>
    /// <see cref="DictionaryEx{TKey, TValue}.Copy"/> creates a deep copy of the collection by
    ...
    /// </item><item>
    /// <see cref="DictionaryEx{TKey, TValue}.Empty"/> returns an immutable empty collection that is
    /// cached for repeated access.
    /// </item><item>
    /// <see cref="DictionaryEx{TKey, TValue}.Equals"/> compares two collections with identical
    ...
    [Serializable]
    public class DictionaryEx<TKey, TValue>: IDictionary<TKey, TValue>, IDictionary, ICloneable {
        #region DictionaryEx()
        ...
        /// </overloads>
        /// <summary>
        /// Initializes a new instance of the <see cref="DictionaryEx{TKey, TValue}"/> class that is
        ...
        #endregion
        #region DictionaryEx(IDictionary<TKey, TValue>)
        ...
        #endregion
        #region DictionaryEx(IDictionary<TKey, TValue>, IEqualityComparer<TKey>)
        ...
        /// collection.</param>
        /// <param name="comparer">
        /// The <see cref="IEqualityComparer{TKey}"/> to use when comparing keys, or a null
        /// reference to use the default <see cref="EqualityComparer{T}"/> for <typeparamref
        /// name="TKey"/>.</param>
        /// <exception cref="ArgumentException">
        /// <paramref name="dictionary"/> contains one or more duplicate keys.</exception>
        /// <exception cref="ArgumentNullException"><para>
        ...
        /// TValue}.Key"/>.</exception>
        /// <remarks>
        /// Please refer to <see cref="Dictionary{TKey, TValue}(IDictionary{TKey, TValue},
        /// IEqualityComparer{TKey})"/> for details.</remarks>
        ...
        #endregion
        #region DictionaryEx(IEqualityComparer<TKey>)
        ...
        /// name="TKey"/>.</param>
        /// <remarks>
        /// Please refer to <see cref="Dictionary{TKey, TValue}(IEqualityComparer{TKey})"/> for
        /// details.</remarks>
        ...
        /// <typeparamref name="TKey"/>.</summary>
        /// <param name="capacity">
        /// The number of elements that the new <see cref="DictionaryEx{TKey, TValue}"/> is
        ...
        #endregion
        #region DictionaryEx(Int32, IEqualityComparer<TKey>)
        ...
        /// <paramref name="capacity"/> is less than zero.</exception>
        /// <remarks>
        /// Please refer to <see cref="Dictionary{TKey, TValue}(Int32, IEqualityComparer{TKey})"/>
        /// for details.</remarks>
        ...
        #endregion
        #region DictionaryEx(DictionaryEx<TKey, TValue>, Boolean)

        /// <summary>
        /// Initializes a new instance of the <see cref="DictionaryEx{TKey, TValue}"/> class that is
        /// a read-only view of the specified instance.</summary>
        /// <param name="dictionary">
        /// The <see cref="DictionaryEx{TKey, TValue}"/> collection that provides the initial value
        ...
        protected DictionaryEx(DictionaryEx<TKey, TValue> dictionary, bool readOnly) {
            if (dictionary == null)
                ThrowHelper.ThrowArgumentNullException("dictionary");
        ...
        /// <summary>
        /// The <see cref="Dictionary{TKey, TValue}"/> collection that holds the <typeparamref
        /// name="TKey"/> keys and <typeparamref name="TValue"/> values of the <see
        /// cref="DictionaryEx{TKey, TValue}"/>.</summary>
        ...
        /// <summary>
        /// The read-only <see cref="DictionaryEx{TKey, TValue}"/> collection that is returned by
        /// the <see cref="AsReadOnly"/> method.</summary>

        protected DictionaryEx<TKey, TValue> ReadOnlyWrapper;

        #endregion
        #region Empty

        /// <summary>
        /// An empty read-only <see cref="DictionaryEx{TKey, TValue}"/>.</summary>
        /// <remarks>
        ...
        public static readonly DictionaryEx<TKey, TValue> Empty =
            new DictionaryEx<TKey, TValue>(0).AsReadOnly();
        ...
        /// <summary>
        /// Gets the <see cref="IEqualityComparer{TKey}"/> that is used to determine equality of
        /// keys in the <see cref="DictionaryEx{TKey, TValue}"/>.</summary>
        /// <value>
        /// The <see cref="IEqualityComparer{TKey}"/> instance that is used to compare keys for
        /// equality, and to provide hash values for the keys.</value>
        /// <remarks>
        /// Please refer to <see cref="Dictionary{TKey, TValue}.Comparer"/> for details.</remarks>
        ...
        /// <summary>
        /// Gets the number of key-and-value pairs contained in the <see cref="DictionaryEx{TKey,
        /// TValue}"/>.</summary>
        /// <value>
        /// The number of <see cref="KeyValuePair{TKey, TValue}"/> elements contained in the <see
        /// cref="DictionaryEx{TKey, TValue}"/>.</value>
        /// <remarks>
        ...
        /// <summary>
        /// Gets a value indicating whether the <see cref="DictionaryEx{TKey, TValue}"/> has a fixed
        /// size.</summary>
        /// <value>
        /// <c>true</c> if the <see cref="DictionaryEx{TKey, TValue}"/> has a fixed size; otherwise,
        ...
        /// since any fixed-size <see cref="DictionaryEx{TKey, TValue}"/> is also read-only, and
        ...
        /// <summary>
        /// Gets a value indicating whether the <see cref="DictionaryEx{TKey, TValue}"/> is
        /// read-only.</summary>
        /// <value>
        /// <c>true</c> if the <see cref="DictionaryEx{TKey, TValue}"/> is read-only; otherwise,
        /// <c>false</c>. The default is <c>false</c>.</value>
        /// <remarks>
        ...
        /// <summary>
        /// Gets a value indicating whether access to the <see cref="DictionaryEx{TKey, TValue}"/>
        /// is synchronized (thread-safe).</summary>
        /// <value>
        /// <c>true</c> if access to the <see cref="DictionaryEx{TKey, TValue}"/> is synchronized
        ...
        /// specified key and value to the <see cref="DictionaryEx{TKey, TValue}"/>.</para></value>
        /// <exception cref="ArgumentNullException">
        ...
        /// cref="DictionaryEx{TKey, TValue}"/>.</exception>
        /// <exception cref="NotSupportedException">
        /// The property is set, and the <see cref="DictionaryEx{TKey, TValue}"/> is read-only.
        /// </exception>
        /// <remarks>
        ...
        /// <summary>
        /// Gets a collection containing the keys in the <see cref="DictionaryEx{TKey, TValue}"/>.
        /// </summary>
        /// <value>
        /// A read-only <see cref="Dictionary{TKey, TValue}.KeyCollection"/> containing the keys in
        /// the <see cref="DictionaryEx{TKey, TValue}"/>.</value>
        /// <remarks>
        ...
        /// cref="DictionaryEx{TKey, TValue}"/>.</summary>
        /// <value>
        /// An object that can be used to synchronize access to the <see cref="DictionaryEx{TKey,
        /// TValue}"/>.</value>
        /// <remarks><para>
        /// Please refer to <see cref="ICollection.SyncRoot"/> for details.
        /// </para><para>
        /// When synchronizing multi-threaded access to the <see cref="DictionaryEx{TKey,
        ...
        /// <summary>
        /// Gets a collection containing the values in the <see cref="DictionaryEx{TKey, TValue}"/>.
        /// </summary>
        /// <value>
        /// A read-only <see cref="Dictionary{TKey, TValue}.ValueCollection"/> containing the values
        /// in the <see cref="DictionaryEx{TKey, TValue}"/>.</value>
        /// <remarks>
        ...
        /// <overloads>
        /// Adds the specified element to the <see cref="DictionaryEx{TKey, TValue}"/>.</overloads>
        /// <summary>
        /// Adds the specified key and value to the <see cref="DictionaryEx{TKey, TValue}"/>.
        /// </summary>
        /// <param name="key">
        ...
        /// <exception cref="ArgumentException">
        /// <paramref name="key"/> already exists in the <see cref="DictionaryEx{TKey, TValue}"/>.
        /// </exception>
        /// <exception cref="ArgumentNullException">
        /// <paramref name="key"/> is a null reference.</exception>
        /// <exception cref="KeyMismatchException">
        ...
        /// <exception cref="NotSupportedException">
        /// The <see cref="DictionaryEx{TKey, TValue}"/> is read-only.</exception>
        /// <remarks>
        ...
        /// <summary>
        /// Adds the specified key-and-value pair to the <see cref="DictionaryEx{TKey, TValue}"/>.
        /// </summary>
        /// <param name="pair">
        ...
        /// already exists in the <see cref="DictionaryEx{TKey, TValue}"/>.</exception>
        /// <exception cref="ArgumentNullException">
        ...
        /// <summary>
        /// Adds the elements of the specified collection to the <see cref="DictionaryEx{TKey,
        /// TValue}"/>. </summary>
        /// <param name="dictionary">
        ...
        /// The <see cref="DictionaryEx{TKey, TValue}"/> is read-only.
        /// </para><para>-or-</para><para>
        /// The <see cref="DictionaryEx{TKey, TValue}"/> already contains one or more keys in the
        ...
        /// <summary>
        /// Returns a read-only view of the <see cref="DictionaryEx{TKey, TValue}"/>.</summary>
        /// <returns>
        /// A read-only wrapper around the <see cref="DictionaryEx{TKey, TValue}"/>.</returns>
        /// <remarks><para>
        ...
        public DictionaryEx<TKey, TValue> AsReadOnly() {

            if (ReadOnlyWrapper == null)
                ReadOnlyWrapper = new DictionaryEx<TKey, TValue>(this, true);
        ...
        /// <summary>
        /// Removes all elements from the <see cref="DictionaryEx{TKey, TValue}"/>.</summary>
        /// <exception cref="NotSupportedException">
        /// The <see cref="DictionaryEx{TKey, TValue}"/> is read-only.</exception>
        /// <remarks>
        ...
        /// <summary>
        /// Creates a shallow copy of the <see cref="DictionaryEx{TKey, TValue}"/>.</summary>
        /// <returns>
        /// A shallow copy of the <see cref="DictionaryEx{TKey, TValue}"/>.</returns>
        /// <remarks>
        /// <b>Clone</b> does not preserve the enumeration order of the <see
        /// cref="DictionaryEx{TKey, TValue}"/>, nor the values of the <see cref="IsFixedSize"/> and
        /// <see cref="IsReadOnly"/> properties.</remarks>

        public virtual object Clone() {
            return new DictionaryEx<TKey, TValue>(this);
        }
        ...
        /// <summary>
        /// Determines whether the <see cref="DictionaryEx{TKey, TValue}"/> contains the specified
        /// key-and-value pair.</summary>
        /// <param name="pair">
        /// The <see cref="KeyValuePair{TKey, TValue}"/> element to locate.</param>
        /// <returns>
        /// <c>true</c> if <paramref name="pair"/> is found in the <see cref="DictionaryEx{TKey,
        ...
        /// <returns>
        /// <c>true</c> if the <see cref="DictionaryEx{TKey, TValue}"/> contains an element with the
        ...
        /// <summary>
        /// Creates a deep copy of the <see cref="DictionaryEx{TKey, TValue}"/>.</summary>
        /// <returns>
        /// A deep copy of the <see cref="DictionaryEx{TKey, TValue}"/>.</returns>
        /// <exception cref="InvalidCastException">
        ...
        /// cref="DictionaryEx{TKey, TValue}"/> by invoking <see cref="ICloneable.Clone"/> on all 
        /// <typeparamref name="TValue"/> values. The <typeparamref name="TKey"/> keys are always
        /// duplicated by a shallow copy.
        /// </para><para>
        /// <b>Copy</b> does not preserve the enumeration order of the <see cref="DictionaryEx{TKey,
        /// TValue}"/>, nor the values of the <see cref="IsFixedSize"/> and <see cref="IsReadOnly"/>
        /// properties.</para></remarks>

        public DictionaryEx<TKey, TValue> Copy() {
            DictionaryEx<TKey, TValue> copy = new DictionaryEx<TKey, TValue>(Count);
        ...
        /// <summary>
        /// Copies the entire <see cref="DictionaryEx{TKey, TValue}"/> to a one-dimensional <see
        ...
        /// cref="DictionaryEx{TKey, TValue}"/>. The <b>Array</b> must have zero-based indexing.
        /// </param>
        ...
        /// name="array"/>.
        /// </para><para>-or-</para><para>
        /// The number of elements in the source <see cref="DictionaryEx{TKey, TValue}"/> is greater
        ...
        /// current <see cref="DictionaryEx{TKey, TValue}"/>.</summary>
        /// <param name="collection">
        /// The <see cref="ICollection{T}"/> of <see cref="KeyValuePair{TKey, TValue}"/> elements to
        /// compare with the current <see cref="DictionaryEx{TKey, TValue}"/>.</param>
        /// <returns><para>
        /// <c>true</c> under the following conditions, otherwise <c>false</c>:
        /// </para><list type="bullet"><item>
        /// <paramref name="collection"/> is another reference to this <see cref="DictionaryEx{TKey,
        /// TValue}"/>.
        /// </item><item>
        /// <paramref name="collection"/> is not a null reference, contains the same number of
        /// elements as this <see cref="DictionaryEx{TKey, TValue}"/>, and each element compares as
        /// equal to the element with the same <see cref="KeyValuePair{TKey, TValue}.Key"/>.
        /// </item></list></returns>
        /// <remarks><para>
        ...
        /// the <see cref="DictionaryEx{TKey, TValue}"/> class does not define a fixed enumeration
        /// order.</para></remarks>
        ...
        /// <summary>
        /// Returns a <see cref="Dictionary{TKey, TValue}.Enumerator"/> that can iterate through the
        /// <see cref="DictionaryEx{TKey, TValue}"/>.</summary>
        /// <returns>
        /// A <see cref="Dictionary{TKey, TValue}.Enumerator"/> for the entire <see
        /// cref="DictionaryEx{TKey, TValue}"/>. Each enumerated item is a <see
        ...
        /// cref="DictionaryEx{TKey, TValue}"/>.</summary>
        /// <returns>
        /// An <see cref="IEnumerator{T}"/> for the entire <see cref="DictionaryEx{TKey, TValue}"/>.
        ...
        /// cref="DictionaryEx{TKey, TValue}"/>.</summary>
        /// <returns>
        /// An <see cref="IDictionaryEnumerator"/> for the entire <see cref="DictionaryEx{TKey,
        ...
        /// cref="DictionaryEx{TKey, TValue}"/>.</summary>
        /// <returns>
        /// An <see cref="IEnumerator"/> for the entire <see cref="DictionaryEx{TKey, TValue}"/>.
        /// Each enumerated item is a <see cref="KeyValuePair{TKey, TValue}"/>.</returns>
        ...
        /// <overloads>
        /// Removes the specified element from the <see cref="DictionaryEx{TKey, TValue}"/>.
        /// </overloads>
        /// <summary>
        /// Removes the element with the specified key from the <see cref="DictionaryEx{TKey,
        /// TValue}"/>.</summary>
        /// <param name="key">
        ...
        /// <summary>
        /// Removes the specified key-and-value pair from the <see cref="DictionaryEx{TKey,
        /// TValue}"/>.</summary>
        /// <param name="pair">
        ...
        /// <summary>
        /// Copies the key-and-value pairs of the <see cref="DictionaryEx{TKey, TValue}"/> to a new
        /// <see cref="Array"/>.</summary>
        /// <returns>
        /// A one-dimensional <see cref="Array"/> containing copies of the <see
        /// cref="KeyValuePair{TKey, TValue}"/> elements of the <see cref="DictionaryEx{TKey,
        /// TValue}"/>.</returns>
        /// <remarks>
